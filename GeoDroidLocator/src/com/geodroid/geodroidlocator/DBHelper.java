...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.geodroid.geodroidlocator/";
	...
	public String getStreetFromID(int id){
		Cursor c = database.query(DB_TABLE, new String[]{STREETNAME}, ID + "="+ id, 
				null, null, null, null);
		c.moveToFirst();
	...
	public double getLatFromAddress(String street, int houseNumber){
		double lat = -1;
		//db contains two streets with ' in their names. Causes trouble, this
		//is a quick-fix, hardcoded.
		Cursor c;
		if(street.contains("'t Hoff")){	
			c = database.query(DB_TABLE, new String[]{LATITUDE}, STREETNAME + " like '%t Hoff%'" + " and "+ HOUSENUMBER + "=" +houseNumber, 
					null, null, null, null);
		}
		if(street.contains("'t Hofj")){	
			c = database.query(DB_TABLE, new String[]{LATITUDE}, STREETNAME + " like '%t Hofj%'" + " and "+ HOUSENUMBER + "=" +houseNumber, 
					null, null, null, null);
		}
		else{
			c = database.query(DB_TABLE, new String[]{LATITUDE}, STREETNAME + "='"+ street + "' and "+ HOUSENUMBER + "=" +houseNumber, 
					null, null, null, null);			
		}
		if(c.moveToFirst()){
			c.moveToFirst();
	...
	public double getLongFromAddress(String street, int houseNumber){
		//db contains two streets with ' in their names. Causes trouble, this
		//is a quick-fix, hardcoded.
		Cursor c;
		if(street.contains("'t Hoff")){	
			c = database.query(DB_TABLE, new String[]{LONGITUDE}, STREETNAME + " like '%t Hoff%'" + " and "+ HOUSENUMBER + "=" +houseNumber, 
					null, null, null, null);
		}
		if(street.contains("'t Hofj")){	
			c = database.query(DB_TABLE, new String[]{LONGITUDE}, STREETNAME + " like '%t Hofj%'" + " and "+ HOUSENUMBER + "=" +houseNumber, 
					null, null, null, null);
		}
		else{
			c = database.query(DB_TABLE, new String[]{LONGITUDE}, STREETNAME + "='"+ street + "' and "+ HOUSENUMBER + "=" +houseNumber, 
					null, null, null, null);
		}
		c.moveToFirst();
		return c.getDouble(0);
	...
	public Cursor getDistinctStreetNames(){
		return database.query(DB_TABLE, new String[]{"distinct " + STREETNAME + " as _id"}, 
	...
	public Cursor getHouseNumbersFromStreetName(String streetName){
		...
		if(streetName.contains("'t Hoff")){	
			return database.query(DB_TABLE, new String[]{"distinct "+HOUSENUMBER}, 
					STREETNAME +" like "+ "'%t Hoff%'", null, null, null, HOUSENUMBER);
		}
		if(streetName.contains("'t Hofj")){	
			return database.query(DB_TABLE, new String[]{"distinct "+HOUSENUMBER}, 
					STREETNAME +" like "+ "'%t Hofj%'", null, null, null, HOUSENUMBER);
		}
		else{
			return database.query(DB_TABLE, new String[]{"distinct "+HOUSENUMBER}, 
					STREETNAME +" = "+ "'"+streetName+"'", null, null, null, HOUSENUMBER);			
		}
