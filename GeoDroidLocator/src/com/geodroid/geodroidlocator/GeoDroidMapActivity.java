...
/**TODO=========================================================
 * Move location listener to GeoDroidLocatorActivity and require
...
public class GeoDroidMapActivity extends Activity {
	...
	//instance variables
	    ...
	    private void updateWithNewLocation(Location loc) {
			...
			if(loc!=null){	
				...
				//bearing between two sets of decimal coordinates
